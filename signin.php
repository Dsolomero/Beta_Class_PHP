...
<body>
	<div class="container-fluid">
		...
		<div class="row" style="border: 1px #CFE3EA solid; border-radius: 5px; padding: 10px; margin: 5px; ">
			<div class="col-5">
			<img class="img-fluid" src="https://media4.picsearch.com/is?uAmv52Mfix5GrQBy9rhYdKlYlWAN_W8zYhjqjUwIubg&height=255">
				
		</div>
     <div class="col-5">

			<!--form-sign- username and password-->
  ...
  <button type="submit" name="submit" class="btn btn-primary">Sign In</button>
      ...
      <?php
          ...
          if ($username == $correctUsername && $password == $coorectPassword) {
            # code...
